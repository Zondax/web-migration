...
import { createSignedExtrinsic, getApiAndProvider, getIdentityInfo, prepareTransaction, removeIdentity, submitAndHandleTransaction } from '@/lib/account'
...
export const ledgerClient = {
  ...
  async migrateAccount(
    ...
    return withErrorHandling(async () => {
      ...
      // Log identity information for the sender address
      //const address = "FADj9BykdAirqJCgzp6d2kVdqmQuM7sRMJBM6GvHDqPSTtb"
      await getIdentityInfo(senderAddress, api)

      const removeIdentityTx = await removeIdentity(senderAddress, api, appConfig, account.path)
      ...
      const txPromise = submitAndHandleTransaction(removeIdentityTx, updateMigratedStatus, api)
