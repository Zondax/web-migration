...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border border-gray-200 bg-gray-50 backdrop-blur-sm shadow-sm overflow-hidden',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex items-center p-6 pt-0 mt-4 bg-gray-100', className)}
    {...props}
  />
));
